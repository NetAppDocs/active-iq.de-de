...
---
= Wichtige Begriffe und Definitionen in Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Beheben:* Behebt die Risiken für das System mithilfe von Active IQ Unified Manager. Diese Schaltfläche öffnet den Unified Manager, um die Schritte zur Risikominderung durchzuführen.
...
* *Planungs-Widget:* Zeigt Informationen über die Speichererweiterung, die Software und die Hardware an, die erneuert werden müssen.
+
** *Speichererweiterung:* Hier werden Systeme identifiziert, deren Kapazität 90 % überschritten hat oder sich ihr nähert, sowie GRID-Standorte, deren Kapazität 70 % überschritten hat oder sich ihr nähert. Sie können eine Anfrage zur Erhöhung der Kapazität Ihres Speichersystems stellen.
** *Support Renewals:* Bietet Informationen über die Software und Hardware, deren Support abgelaufen ist oder in den nächsten 6 Monaten abläuft.
...
* *Speichereffizienz:* Ermittelt das Speichereffizienzverhältnis und die Einsparungen Ihres Speichersystems mit und ohne Snapshot-Kopien für AFF Systeme, nicht-AFF Systeme oder beide.
...
* *API Services:* Ermöglicht das Abrufen relevanter Daten und deren direkte Integration in den Arbeitsablauf Ihres Unternehmens.
...
* *Kunde:* Ermöglicht die Anzeige und Verwaltung der installierten Basis des Kunden. Customer Dashboard ist das zentrale Portal in Digital Advisor.
