...
---
= Erfahren Sie mehr über Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Behebung:* Behebt die Risiken für das System mithilfe von Active IQ Unified Manager. Mit dieser Schaltfläche wird der Unified Manager gestartet, um die Schritte zur Risikominderung durchzuführen.
