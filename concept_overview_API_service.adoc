...
---
= Erfahren Sie mehr über die Digital Advisor API-Dienste.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Beide Ansichten ermöglichen es dem Benutzer, die verfügbaren Elemente mithilfe des Navigationsbereichs auf der linken Seite zu durchsuchen. Die Elemente sind alphabetisch nach Dienst geordnet. Innerhalb eines bestimmten Dienstes lässt sich die Überschrift erweitern, um die einzelnen API Endpunkte anzuzeigen. Die Auswahl der Dienstüberschrift oder eines API Endpunkts führt zum entsprechenden Abschnitt des Katalogs im mittleren Bereich.
...
Informationen zum Zugriff auf und zur Nutzung von Digital Advisor APIs finden Sie unter link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor API-Dokumentation"].
