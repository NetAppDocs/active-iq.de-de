...
keywords: activeiq, sustainability dashboard, recommended actions, digital advisor, sustainability core, cluster level, netapp console 
summary: Bietet Schritte zur Verbesserung der Nachhaltigkeitsbewertung durch die empfohlenen Maßnahmen. 
---
= Verbessern Sie die Nachhaltigkeitsbewertung Ihres Speichersystems mit Hilfe von Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
NOTE: Um die besten Ergebnisse mit dem Dashboard zu erzielen, müssen Sie AutoSupport aktivieren.  Wenn AutoSupport nicht aktiviert ist, basieren die Daten auf Produktspezifikationen.  Um Echtzeit-Stromdetails zu erhalten, müssen Sie Data Infrastructure Insights aktivieren.  Weitere Informationen zum Aktivieren von Data Infrastructure Insights finden Sie unterlink:https://docs.netapp.com/us-en/data-infrastructure-insights/task_getting_started_with_cloud_insights.html["Data Infrastructure Insights"^] .
...
.NetApp Konsole
--
. Gehen Sie in der linken Navigationsleiste der Konsole in der Kategorie *Gesundheit* zu *Nachhaltigkeit*.
...
*** Sie können die verschobenen Aktionen jederzeit einsehen und *In Betracht ziehen* auswählen, um sie auf die Registerkarte *Empfohlene Aktionen* zu verschieben. + image:actions_for_later.png["Ein Screenshot, der empfohlene Aktionen mit der Option „Erwägung“ zeigt."]
...
--
. Gehen Sie in der linken Navigationsleiste der Konsole in der Kategorie *Gesundheit* zu *Nachhaltigkeit*.
. Gehen Sie zur Tabelle *Systeme*.
. Die Anzahl der Aktionen aus der Spalte *Empfohlene Aktionen* für den Zielcluster auswählen.
+
...
** Wenn Sie *later* auswählen, wird die ausgewählte empfohlene Aktion auf die Registerkarte *actions for later* verschoben. Die ausgewählte Aktion wird um 30 Tage verschoben. Nach 30 Tagen wird diese Aktion zur Registerkarte *Empfohlene Aktionen* verschoben.
** Sie können die verschobenen Aktionen jederzeit überprüfen und *In Betracht ziehen* auswählen, um sie auf die Registerkarte *Empfohlene Aktionen* zu verschieben.





TIP: Sie können die Umgebungsparameter in der Tabelle *Systeme* hinzufügen oder entfernen, indem Sieimage:add_icon.png["Ein Plus-Symbol zum Hinzufügen oder Entfernen der Parameter"] Symbol und können diese Tabelle im CSV-Format (Comma-Separated Values) exportieren, indem Sie dasimage:download_icon.png["Ein Download-Symbol zum Exportieren des Parameters"] Symbol.

--
.Digital Advisor
--
. Gehen Sie zu *Nachhaltigkeit*, verfügbar in der linken Navigation des Digital Advisor Dashboards.
. Gehen Sie zur Registerkarte *Empfohlene Aktionen*.
. Gehen Sie zur Tabelle *Systeme*.
. Die Anzahl der Aktionen aus der Spalte *Empfohlene Aktionen* für den Zielcluster auswählen.
+
