...
* *AutoSupport Adoption*: Zeigt die Anzahl und den Prozentsatz der Systeme mit aktiviertem AutoSupport an. Es lassen sich auch Systeme mit dem Status „Declined“, solche mit aktiviertem *HTTPS* und *AutoSupport on Demand* sowie *Loss of Signal* für Systeme anzeigen, die in den letzten 7 Tagen keine AutoSupport-Daten mehr gesendet haben. Zur Anzeige des Health-Check-Scores und von Informationen zu den Systemen in Ihrer installierten Basis steht das Widget *AutoSupport Adoption* zur Verfügung.
