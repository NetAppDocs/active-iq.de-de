...
* Sehen Sie sich den Nachhaltigkeitswert und den prognostizierten Stromverbrauch, direkten Kohlenstoff und die Wärmeabgabe an. Ausgehend von der Nachhaltigkeitsscore beurteilen Sie die allgemeine Effizienz Ihrer Storage-Systeme und passen sie an die empfohlenen Maßnahmen von NetApp zur Verbesserung des erzielten Ergebnisses an. link:learn_BlueXP_sustainability.html["Weitere Informationen ."^].
