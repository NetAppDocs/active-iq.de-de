...
---
= Erfahren Sie mehr über die Funktionen von Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
* Sehen Sie sich den Nachhaltigkeitswert und den prognostizierten Verbrauch von Strom, direktem Kohlenstoff und Wärme an.  Bewerten Sie anhand des Nachhaltigkeits-Scores die Gesamteffizienz Ihrer Speichersysteme und orientieren Sie sich an den von NetApp empfohlenen Maßnahmen zur Verbesserung des Scores. link:learn-about-sustainability.html["Weitere Informationen ."^] .
* Datenreduktionsrate, belegter logischer Speicherplatz, belegter physischer Speicherplatz und insgesamt eingesparte Daten.
...
* link:concept_value_insights.html["Value Insights entdecken"], das allgemeine Informationen zu Gesundheit, Einsparungen, Stabilität und Sicherheit für Ihr ONTAP System bereitstellt.
