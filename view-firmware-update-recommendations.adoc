...
keywords: Upgrade Advisor, firmware recommendations, storage firmware, SP and BMC firmware, system files, security files 
summary: Aktualisierungsempfehlungen für Speicher-Firmware, SP und BMC Firmware, Systemdateien und Sicherheitsdateien anzeigen. 
---
