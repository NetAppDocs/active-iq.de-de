...
* Aktivieren Sie die Überwachung aus der Spalte *Echtzeit-Power*, um die Details der Echtzeit-Stromversorgung auf Cluster-Ebene anzuzeigen. Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/cloudinsights/task_getting_started_with_cloud_insights.html["Einblicke in die Cloud"^].
