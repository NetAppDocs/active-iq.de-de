...
---
= Führen Sie das Ansible-Playbook ohne das NetApp Docker-Image aus.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
----
+
Weitere Informationen zum Befehl ansible-galaxy sind unter link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Ansible-Galaxy-Dokumentation"^] verfügbar, und weitere Informationen zur NetApp Ansible Collection sind unter link:https://galaxy.ansible.com/netapp/ontap["NetApp Ansible Collection-Seite"^] verfügbar.
