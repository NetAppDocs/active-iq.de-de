...
---
= Erstellen Sie eine Watchlist in Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Sie können eine Watchlist erstellen, um schnell und einfach auf eine Reihe von Speichersystemen zuzugreifen. Sie können die Speichersysteme anhand der Kategorie oder der Seriennummer hinzufügen.


NOTE: Sie können maximal 15.000 Speichersysteme unter einer Kategorie und 500 Speichersysteme unter einer Seriennummer hinzufügen.
...
. *Watchlist erstellen* auswählen.
. Geben Sie einen Namen für die Watchlist ein.
. Wählen Sie eine der folgenden Optionen aus, um Speichersysteme zur Beobachtungsliste hinzuzufügen:
+
