...
summary: Informationen zu neuen Funktionen und Verbesserungen im Digital Advisor. 
---
...
Die Funktion „Virtuelle Maschine“ ist im Digital Advisor ab Oktober 2026 veraltet.
...
* Die Funktion „Tech-Aktualisierung“ heißt jetzt „Systemaktualisierung“. Erfahren Sie, wie das geht link:https://docs.netapp.com/us-en/active-iq/evaluate-tech-refresh.html["eine Systemaktualisierung bewerten"].
* Die Funktion „Kapazitätserweiterungen“ heißt jetzt „Speichererweiterung“. Erfahren Sie mehr link:https://docs.netapp.com/us-en/active-iq/concept_getting_started_2.html["Digital Advisor Widgets"].
...
Nachhaltigkeit wird jetzt auf E-Series- und StorageGRID Systemen unterstützt.  Sie können eine Liste empfohlener Maßnahmen und Umweltindikatoren anzeigen, die Prognosen für Strom, direkten Kohlenstoffverbrauch und Wärme aus dem Nachhaltigkeits-Dashboard für diese Systeme anzeigen. Weitere Informationen finden Sie unterlink:https://docs.netapp.com/us-en/active-iq/sustainability-dashboard-overview.html["Übersicht über das Dashboard „Nachhaltigkeit“"^] .
...
* Der Wellness-Workflow enthält jetzt das Nachhaltigkeits-Widget, das die Anzahl der empfohlenen Maßnahmen auf Kunden-, Beobachtungslisten-, Standort- und Gruppenebene anzeigt. Die Anzahl der Maßnahmen kann ausgewählt werden, um eine detaillierte Ansicht dieser empfohlenen Maßnahmen im Nachhaltigkeits-Dashboard anzuzeigen. Weitere Informationen sind unter link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Analysieren Sie die Nachhaltigkeit Ihrer Storage-Systeme"] zu finden.
...
* Die Option *Speicherung ohne Snapshot-Backups* wurde in *Mit Snapshot-Kopien* umbenannt, zusammen mit einer Änderung ihrer Funktionalität. link:https://docs.netapp.com/us-en/active-iq/reference_aiq_faq.html#storage-efficiency["Weitere Informationen ."].
...
Das Nachhaltigkeits-Dashboard bietet wertvolle Einblicke in die ökologische Nachhaltigkeit Ihres Speichersystems.  Sie können Informationen wie Nachhaltigkeitsbewertung, Prozentsatz der Kohlenstoffreduzierung, voraussichtlichen Stromverbrauch, direkten Kohlenstoffausstoß und Wärmeverbrauch anzeigen.  Sie können den Prozentsatz der CO2-Minderung für bestimmte Standorte anpassen.  Sie können den Nachhaltigkeits-Score auch auf Clusterebene anzeigen.  Anhand des Nachhaltigkeits-Scores können Sie die Gesamteffizienz Ihres Speichersystems beurteilen und es mit den von NetApp empfohlenen Maßnahmen zur Verbesserung der Nachhaltigkeit abstimmen. link:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Weitere Informationen ."] .
...
Die SAN- und NAS-Speichereffizienz ist auf Knotenebene für ONTAP Systeme einschließlich AFF A-Series, AFF C190, All SAN Array und FAS500 verfügbar.
...
=== Digital Advisor Integration mit NetApp Console

Active IQ Digital Advisor wird zu Digital Advisor und ist jetzt in die NetApp Console integriert, NetApps einheitliche Managementkonsole für hybride Multicloud-Umgebungen. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Weitere Informationen ."].
...
NetApp Console-Benutzer können jetzt, wo immer zutreffend, Digital Advisor-Links in neuen Tabs öffnen, ähnlich der bestehenden Funktionalität in Digital Advisor.
...
* In der E-Mail zur Wellness-Überprüfung finden Sie Informationen zum Ransomware-Schutz anstelle von Vertragsverlängerungen.
...
Bei Auswahl des blauen Feldes „Volume Summary“ in der SVM-Tabelle erscheint ein Pop-out, das detaillierte Informationen zu den Volumes anzeigt, die auf der jeweiligen Seriennummer oder dem jeweiligen physischen Knoten gehostet oder diesem zugeordnet sind.
...
* *Planungs-Widget:*
+
** *Kapazitätserweiterungen:* Sie werden benachrichtigt, sobald ein GRID-Standort den Schwellenwert von 70 % der bestehenden Kapazität überschreitet. Es besteht die Möglichkeit, die Kapazität der StorageGRIDs am Standort für die nächsten 1, 3 und 6 Monate zu erweitern, falls der Kapazitätsschwellenwert voraussichtlich 70 % überschreiten wird.
** *Verlängerungen:* Für alle StorageGRID-Systeme, bei denen der Lizenzvertrag abgelaufen ist oder in den nächsten 6 Monaten abläuft, erfolgt eine Benachrichtigung. Es besteht die Möglichkeit, ein oder mehrere Systeme auszuwählen, um eine Anfrage zur Verlängerung an das NetApp Support-Team zu richten.
...
* *GRID Viewer:* Im Widget *Konfiguration* kann die GRID-Konfiguration im Detail angezeigt werden, indem der Link *GRID Viewer* ausgewählt wird. Im Widget *Konfiguration* können die Standortdetails und Kapazitätsdetails für das ausgewählte StorageGRID durch Auswahl der Schaltfläche *Download* im *Grid Viewer*-Bildschirm heruntergeladen werden.
...
* *GRID summary:* Enthält grundlegende Informationen wie License Type, License Capacity, Anzahl der installierten Knoten, Support Term (Datum des Lizenzvertragsendes), Primary Admin Node und Primary Site des Primary Admin Node. Diese Registerkarte bietet außerdem den Site-Namen und die Anzahl der dem entsprechenden Site zugeordneten Speicherknoten. In dieser Version ist die Liste der Knotennamen sichtbar, wenn der Hyperlink zum Anzeigen der Speicherknoten für den entsprechenden Site ausgewählt wird.
...
Die Schaltfläche „Tier Data“ wurde dem FabricPool Dashboard hinzugefügt und ermöglicht das Tiering von Daten in kostengünstige Objektspeicherebenen mithilfe der NetApp Console.
...
Mit Digital Advisor APIs lassen sich relevante Daten abrufen und direkt in den Workflow Ihres Unternehmens integrieren. link:https://docs.netapp.com/us-en/active-iq/concept_overview_API_service.html["Weitere Informationen ."].
...
Sie können das Speichereffizienzverhältnis und die Einsparungen Ihres Speichersystems mit und ohne Snapshot-Kopien für AFF Systeme, Nicht-AFF Systeme oder beide anzeigen. Die Informationen zur Speichereffizienz sind auf Knotenebene einsehbar. link:https://docs.netapp.com/us-en/active-iq/task_analyze_storage_efficiency.html["Erfahren Sie, wie"].
