...
Active IQ Digital Advisor wird in Digital Advisor geändert und ist jetzt in BlueXP integriert, die einheitliche Verwaltungskonsole von NetApp für hybride Multicloud-Umgebungen. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Weitere Informationen ."] .
...
* *Planungs-Widget:*
+
** *Kapazitätserweiterungen:* Sie werden benachrichtigt, sobald eine Auslastung von 70 % der bestehenden Kapazität eines GRID-Standorts überschritten wird. Sie haben die Möglichkeit, die Kapazität der StorageGRIDs am Standort für die nächsten 1, 3 und 6 Monate zu erhöhen, falls die Auslastung voraussichtlich 70 % überschreiten wird.
