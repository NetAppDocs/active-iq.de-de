...
. Klicken Sie auf *In die Cloud migrieren*, um die *Konsole* zu starten.
...
. Klicken Sie auf *Tierdaten*, um die *Konsole* zu starten.
...
. Klicken Sie auf *Backup in der Cloud*, um die *Konsole* zu starten.
...
. Klicken Sie auf *In Cloud replizieren*, um die *Konsole* zu starten.
