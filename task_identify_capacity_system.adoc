...
.Schritte
. Klicken Sie im Widget *Planung* auf *Speichererweiterung*.
+
...
. Klicken Sie auf *Senden*, um die Anfrage an das NetApp Speicherteam zu senden, damit es bei der Speichererweiterung für die ausgewählten Systeme unterstützt.
