...
keywords: activeiq, sustainability dashboard, sustainability score, sustainability, environmental indicators, carbon mitigation, recommended actions, systems, best practices, support, recommendations, digital advisor, cluster, sustainability initatives, netapp console 
summary: Bietet Informationen zum Dashboard, zum Nachhaltigkeits-Score, zu Systemen und zu empfohlenen Maßnahmen. 
---
= Erfahren Sie mehr über die Funktionen des Nachhaltigkeits-Dashboards im Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*Kohlenstoffminderungsprozentsätze*: Zeigt den Prozentsatz der Kohlenstoffminderung an jedem Standort/jeder Stadt an, wobei die angezeigten Basiswerte auf Ihrem Standort basieren. Die Kohlenstoffminderungsprozentsätze für bestimmte Standorte lassen sich anpassen, indem das image:edit_icon_1.png["Ein Screenshot mit einem editierbaren Symbol."] Symbol neben den Prozentwerten ausgewählt wird. Die Kohlenstoffwerte passen sich dann automatisch entsprechend an.
