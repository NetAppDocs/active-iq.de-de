...
---
= Erkennen Sie Sicherheitsrisiken mit Digital Advisor und ergreifen Sie Korrekturmaßnahmen.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. Im Widget *Security & Ransomware Defense* die Option *Actions* auswählen.image:Security_Image 2 Ransomware attacks.png["Widget mit Sicherheitsschwachstellen"]
...
. Die Registerkarte *Besondere Risiken* auswählen und dann den Link in der Spalte *Korrekturmaßnahmen* auswählen. image:Corrective Action_Image 2 Ransomware attacks.png["Spalte „Korrekturmaßnahme“"]
+
