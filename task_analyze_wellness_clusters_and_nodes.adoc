...
---
= Überprüfen Sie den Zustand von Clustern und Knoten mithilfe des ClusterViewer-Widgets in Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. Auf Cluster- oder Knotenebene *ClusterViewer* neben dem Widget *Konfiguration* auswählen.
. Die Registerkarte *Visualisierung* zeigt eine grafische Darstellung des Clusters.
