...
---
= Bekannte Einschränkungen des Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Auf der AutoSupport Berichtsseite führt die Auswahl eines der Status, von Systemen, die kürzlich die Übertragung eingestellt haben, oder von Systemen, bei denen AutoSupport deaktiviert ist, nicht zum Bildschirm für die Systemzustandsprüfung.
