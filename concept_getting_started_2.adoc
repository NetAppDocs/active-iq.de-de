...
| Supportverlängerungen | Unterstützung auf allen Plattformen | Unterstützung auf allen Plattformen | Unterstützung auf allen Plattformen 


| Speichererweiterung | Nur auf ONTAP unterstützt | Nur auf ONTAP unterstützt | Nur auf ONTAP unterstützt 


| Inventar | Unterstützung auf allen Plattformen | Nur auf ONTAP unterstützt | Nur auf ONTAP unterstützt 


| Upgrades | Nur auf ONTAP unterstützt | Nur auf ONTAP unterstützt | Nur auf ONTAP unterstützt 
|===

NOTE: Alle Plattformen bedeutet ONTAP, E-Series, StorageGRID, ONTAP Select und Cloud Volumes ONTAP.
